...
async function submitUserMessage(content: string, fileContent: string) {
  ...
  const result = await streamUI({
    ...
    If the user do not provide an offer that he has in mind, ask if he has one. Else, provide offers, for this ask location of the offer and list companies that usually have offers that match the user profile.
